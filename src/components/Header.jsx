...
const Header = () => {
  ...
  return (
    <div className="relative h-screen w-full bg-custom-gray dark:bg-dark-header dark:text-white overflow-hidden">
      <div className="absolute -top-[7%] left-[25%] w-28 h-28 bg-custom-thin-gray-circle dark:bg-custom-bold-gray-circle rounded-[100%] z-1 2xl:w-35 2xl:h-35"></div>
      <div className="absolute bottom-[16%] right-0 w-27 h-15 bg-custom-text-pink rounded-l-[100px] z-1"></div>

      <div className="absolute bottom-0 right-[20%] w-30 h-30 bg-custom-thin-gray-circle dark:bg-custom-bold-gray-circle rounded-t-[100%] translate-y-1/2 z-1 2xl:w-35 2xl:h-35"></div>
      ...
      <div className="flex flex-col w-[78%] gap-4 my-10 mx-auto justify-around relative z-9 h-[80%] xs:gap-0 xl:gap-15 2xl:w-[72%] 2xl:h[80%]">
        <nav className="flex items-center justify-end ml-auto max-w-90 gap-4 py-4 xs:text-sm md:aspect-[359 / 38] 2xl:text-lg 2xl:max-w-120">
        ...
        <div ref={targetRef} className="flex xs:flex-wrap-reverse xs:gap-1 lg:flex-nowrap lg:gap-27">
          <div className="flex flex-col gap-5 text-custom-text-black dark:text-white">
            <div className="font-inter font-normal xs:inline-flex xs:text-3xl 2xl:text-5xl">
              {heroSection.greeting} 👋
            </div>
            <div className="font-inter font-medium xs:leading-16 xs:text-[42px] 2xl:text-7xl 2xl:leading-22">
          ...
          <div className="flex items-center justify-center">
            <div className="relative bg-custom-pink border-2 border-custom-pink rounded-4xl xs:hidden sm:flex  sm:translate-y-10 sm:translate-x-49 sm:w-20 sm:h-20 lg:translate-0 lg:w-85.25 lg:h-85.25 2xl:w-120 2xl:h-120">
              <img
                src={heroSection.profileImage}
                alt={heroSection.profileImage}
                className="absolute rounded-4xl object-cover shadow-2xl z-10 xs:hidden sm:flex  sm:w-20 sm:h-20 sm:top-2 sm:left-2 lg:w-85.25 lg:h-85.25 lg:top-5 lg:left-5 2xl:w-120 2xl:h-120"
              />
            </div>
          </div>
        </div>
