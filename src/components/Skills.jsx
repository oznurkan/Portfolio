...
const Skills = () => {
  ...
  return (
    <div className="w-full relative dark:bg-dark-skills overflow-hidden ">
      ...
      <div className="flex flex-col w-[77%] mx-auto mb-28 sm:mb-5 py-35 items-center gap-15 text-custom-text-black font-inter font-medium relative z-4 xs:py-35 2xl:py-40 ">
        <h1 className="flex font-inter font-medium text-4xl leading-[100%] text-custom-text-black dark:text-custom-gray xs:text-5xl">
          {skillsSection.title}
        </h1>
