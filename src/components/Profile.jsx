...
const Profile = () => {
  ...
  return (
    <div className="w-full relative overflow-hidden bg-custom-gray dark:bg-dark-profile">
      <div className="absolute right-0 top-0 w-30 h-30 bg-custom-text-pink rounded-l-[100%] rounded-b-[100%]  translate-x-[35%] -translate-y-[24%] z-1"></div>
      ...
      >
        <h1 className="flex font-inter font-medium leading-[100%] text-custom-text-black dark:text-custom-gray text-4xl">
        ...
        <div className="flex gap-18 items-center justify-center flex-wrap w-[84%] ">
          <div className="relative lg:flex-1">
            ...
            <div className="relative w-full h-full bg-white dark:bg-custom-bold-gray-circle border-2 border-none rounded-xl z-10 pl-9 pr-7 pt-3">
              <div className="flex flex-col py-12 gap-8">
                <h2 className="font-playfair font-normal text-2xl leading-[100%] text-custom-text-pink">
          ...
          <div className="flex flex-col gap-6 items-start mb-auto pt-11 lg:flex-1">
            ...
            <p className="font-inter font-normal text-lg leading-[150%] text-custom-text-black dark:text-white">
